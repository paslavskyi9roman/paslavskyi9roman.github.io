...
export const ARGUMOSA_SCENE_CLUES: SceneClue[] = [
  {
    ...
    examinePrompt: 'Un tubo abierto sobre el mostrador del kiosko. Coral encendido. La marca: Maja.',
    examinePromptEn: 'An open tube sits on the kiosk counter. Bright coral. The brand: Maja.',
    requires: { clueIds: ['apt_clue_ashtray'] },
    x: 28,
    y: 64,
  },
  {
    ...
    examinePrompt:
      'Un recibo del estanco de Lavapiés en el reverso de un periódico. Dos paquetes de Ducados a las 22:15.',
    examinePromptEn: 'An Estanco Lavapiés receipt on the back of a newspaper. Two packets of Ducados at 22:15.',
    x: 70,
    y: 42,
  },
  {
    ...
    examinePrompt:
      'Una pila de Diarios anotados. La firma de Ramón rodeada en rojo, una y otra vez. Al margen: «¿qué silencio?».',
    examinePromptEn:
      'A stack of annotated Diarios. Ramón\'s byline circled in red, again and again. In the margin: "what silence?"',
    x: 16,
    y: 30,
  },
  {
    ...
    examinePrompt: 'Un albarán de carbón colgando de la cabina. Letras azuladas: «00:07 · 14·X · sin nombre».',
    examinePromptEn: 'A carbon call slip hanging in the booth. Bluish lettering: "00:07 · 14·X · no name."',
    x: 84,
    y: 76,
  },
];
